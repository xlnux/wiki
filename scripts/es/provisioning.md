...
3. Si `X_HYPRLAND` (default `1`), aprovisiona el escritorio Hyprland/equisdots
   (`tools/hyprland-install.sh`, offline desde el snapshot de equisdots
   empaquetado; fallback online vía `equisdots/dots`).
